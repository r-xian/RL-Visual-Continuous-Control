...
#SBATCH --mem=30G
#SBATCH --job-name=finger_curl_sac
#SBATCH --gres=gpu:nvidia_a100_80gb_pcie_1g.10gb
#SBATCH --time=72:00:00
#SBATCH --partition=gpu_cuda
#SBATCH --account=a_lead
#SBATCH -o finger_curl_sac.out
#SBATCH -e finger_curl_sac.error
...
srun python ./src/train.py --agent curl --domain_name finger --task_name spin
srun python ./src/train.py --agent sacae --domain_name finger --task_name spin
