...
#SBATCH --mem=30G
#SBATCH --job-name=cartpole_curl_sac
#SBATCH --gres=gpu:nvidia_a100_80gb_pcie_1g.10gb
#SBATCH --time=72:00:00
#SBATCH --partition=gpu_cuda
#SBATCH --account=a_lead
#SBATCH -o cartpole_curl_sac.out
#SBATCH -e cartpole_curl_sac.error
...
srun python ./src/train.py --agent curl --domain_name cartpole --task_name swingup
srun python ./src/train.py --agent sacae --domain_name cartpole --task_name swingup
