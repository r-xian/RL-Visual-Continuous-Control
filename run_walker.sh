...
#SBATCH --mem=30G
#SBATCH --job-name=walker_curl_sac
#SBATCH --gres=gpu:nvidia_a100_80gb_pcie_1g.10gb
#SBATCH --time=72:00:00
#SBATCH --partition=gpu_cuda
#SBATCH --account=a_lead
#SBATCH -o walker_curl_sac.out
#SBATCH -e walker_curl_sac.error
...
srun python ./src/train.py --agent curl --domain_name walker --task_name walk
srun python ./src/train.py --agent sacae --domain_name walker --task_name walk
